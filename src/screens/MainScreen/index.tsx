...
const MainScreen = ({ navigation }) => {
  ...
  //   const today = moment();
  //   daysOfWeek[today.isoWeekday()] = today;
  ...
  //   //         return (
  //   //           <>
  //   //             <S.DayContainer today={parseInt(key, 10) === today.isoWeekday()}>
  //   //               <S.DayText>teste</S.DayText>

  //   //               <S.CalendarImg
  //   //                 name={
  //   //                   Number(0) === 16 ? 'bell-outline' : 'alert-circle-outline'
  //   //                 }
  //   //               />

  //   //               <S.DayText>teste2</S.DayText>
  //   //             </S.DayContainer>
  //   //           </>
  //   //         );
  //   //       })}
  ...
  return (
    <S.Container>
      ...
      {!showCompleteCalendar && <S.CalendarContainer>{}</S.CalendarContainer>}
      <Calendar />
